...
export const RoundCard = ({ round }: { round: Round }) => {
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col overflow-hidden rounded-2xl border border-skin-stroke bg-white shadow-[0px_4.02px_0px_0px_#BBB] transition hover:-translate-y-0.5 hover:shadow-[0px_6px_0px_0px_#BBB] active:translate-y-1 active:shadow-none"
    >
